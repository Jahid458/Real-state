    ...
    try {
        ...
        if(user  && eventType === "user.created") {
            try {
              ...
              console.log('Error Or Meta Data Error', error);
            }
        }
    } catch (error) {
      console.log("Error could not update or create user metadata:", error);
      return new Response("Couldnot update or create User", { status: 400 });
    }
  }
